...
-- 05.List the top 5 most ordered pizza types 
...
sum( orders_details.quantity)as quantity
 ...
 -- 06.Join the necessary tables to find the 
...
-- 08. Join relevant tables to find the
...
-- 09.Group the orders by date and calculate the average
